 ...
 * =========================================================
 * [수업 코드 영역]
 * 회원가입 흐름: form state -> 입력 검증 -> axios POST -> 성공 시 로그인 화면 이동.
 * 서버로 보내는 실제 필드는 id / name / age / email / password 이다.
 * 비밀번호 확인(passwordConfirm)은 프론트 검증용이라 서버에는 보내지 않는다.
 * 이름 구분: useState/useNavigate/axios는 정해진 이름, form/onChange/onSubmit은 프로젝트에서 정한 이름이다.
 *
 * [디자인 영역]
 * 회원가입 카드와 입력폼 스타일은 site-brand.css에서 관리한다.
 * =========================================================
 */
